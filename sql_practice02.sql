...
insert into child values(null,2002,'Bisiklet','Nuri');
-- child talbosu istisnai olarak parent tabloda primary key de olmasa bile null deger kabul eder.
--SORU 4: .parent tablosundaki vergi_no 101 olan veriyi siliniz.
-- child tablo silinmeden parant tablodan veri silinemez.
delete from parent where vergi_no =101; -- silemeyiz hata verir
--SORU 5: child tablosundaki ted_vergino 101 olan verileri siliniz
delete from child where ted_vergino = 101; -- once child sonra parent tan sileriz
--SORU 6: .parent tablosundaki vergi_no 101 olan veriyi siliniz.
delete from parent where vergi_no = 101; -- once child dan sildigimiz icin parent tan silebiliriz.
--SORU 7: .parent tablosunu siliniz.
-- child tablo silinmeden parent tablo silinemez cunku aralarinda iliski var.
--SORU 8: child tablosunu siliniz.
drop table child; -- tablo tamamen silindi
--SORU 9: .parent tablosunu siliniz.
drop table parent; -- artik parent tablo silinebilir.
------YENI SORU---------------------------------------------
...
delete from parent2; -- on delete cascade sayesinde child tablodaki veriyi silmeden once
--parent tablodaki veriyi sildik. Ama bu durumda child tablodaki veriler de silinmis oldu
-- SORU2 : parent2 tablosunu silini.
drop table parent2 cascade; -- tabloyu tamamen sildik. child tablo silinmeden parent tablo silindi.
